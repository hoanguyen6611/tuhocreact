...
const CardTailwind = (props) => {
    ...
    return (
        <div className="relative ">
            ...
            <div className="absolute left-2/4 -translate-x-2/4 translate-y-2/4 bottom-0 bg-white z-10 rounded-[20px] p-5 w-[363px] h-[127px]"> 
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex items-center gap-x-3">
                        <img src="/iconheart.svg" alt="heart" />
                        <span>256</span>
                    </div>
                </div>
